 ...
 * @copyright  2024 Guillaume Barat
...
class rubric_ranges {
    ...
    public function get_data(\assign $assign, \cm_info $cm): array {
        ...
        $sql = "SELECT grf.id as grfid,
                    ...
                    JOIN {gradingform_rubric_ranges_c} criteria ON (criteria.definitionid = gd.id)
                    JOIN {gradingform_rubric_ranges_l} level ON (level.criterionid = criteria.id)
